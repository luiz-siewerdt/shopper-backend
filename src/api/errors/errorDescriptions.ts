const errorDescriptions = {
  alreadyRead: 'Leitura do mês já realizada',
  ...
  cannotGetMeasureFromImage: 'Não foi possível extrair o valor da imagem',
  internalError: 'Ops, algo deu errado. Tente novamente mais tarde',
}
